...
import { Recycle, Leaf, Droplet, Cpu, Package, Wrench, AlertTriangle, Search } from 'lucide-react';
import SidebarIcon from './SidebarIcon';

const icons = [
	{ icon: Recycle, label: 'Residuos aprovechables', path: '/funcionario' },
	{ icon: Leaf, label: 'Residuos orgánicos', path: '/funcionario/indicadores-organicos' },
	{ icon: Droplet, label: 'Aceite de cocina usado', path: '/funcionario/indicadores-ACU' },
	{ icon: Cpu, label: 'RAEE, RESPEL y RCD', path: '/funcionario/raee-respel-rcd' },
	{ icon: Package, label: 'Residuos voluminosos', path: '/funcionario/residuos-voluminosos' },
	{ icon: Wrench, label: 'UAR y condiciones técnicas', path: '/funcionario/uar-condiciones' },
	{ icon: AlertTriangle, label: 'Información de gestores', path: '/funcionario/informacion-de-gestores' },
	{ icon: Search, label: 'Buscador', path: '/funcionario/buscador' },
];

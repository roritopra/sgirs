...
export const Step1Documentation = () => {
  ...
  const initialValues = useMemo(() => {
    return questions && questions.length > 0 ? { [questions[0].id]: state.manualSGIRS } : {};
  }, [questions, state.manualSGIRS]);
  ...
  const handleValueChange = (id: string, value: any) => {
    ...
    updateForm({ manualSGIRS: value as boolean | null });
  };
